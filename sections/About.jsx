...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    className={`${styles.innerWdith} mx-auto ${styles.flexCenter} flex-col`}>
<TypingText title="| About Metaversus" textTyles="text-center"/>
<motion.p
variatns={fadeIn('up', 'tween', 0.2, 1)}
 ...
 madness of the metaverse
  ...
  <span className='font-extrabold text-white'> VR </span> devices you can easily
   ...
   <span className='font-extrabold text-white'> explore </span> 
     ...
     the metaverse world you want, turn your dreams into reality. Let's explore the
